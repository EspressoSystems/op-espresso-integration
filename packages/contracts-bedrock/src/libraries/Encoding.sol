...
library Encoding {
    ...
    /// @param espresso            Whether the Espresso Sequencer is enabled.
    /// @param espressoL1ConfDepth Minimum confirmation depth for L1 origin blocks.
    /// @param justification       The RLP-encoded L2 batch justification.
