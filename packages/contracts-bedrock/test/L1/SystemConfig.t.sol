...
contract SystemConfig_Initialize_Test is SystemConfig_Init {
    ...
    function setUp() public virtual override {
        ...
        espresso = deploy.cfg().espresso();
        espressoL1ConfDepth = uint64(deploy.cfg().espressoL1ConfDepth());
    ...
    function test_constructor_succeeds() external {
        ...
        assertEq(impl.espresso(), false);
        assertEq(impl.espressoL1ConfDepth(), 0);
    ...
    function test_initialize_succeeds() external {
        ...
        assertEq(systemConfig.espresso(), espresso);
        assertEq(systemConfig.espressoL1ConfDepth(), espressoL1ConfDepth);
