...
func NewDriver(driverCfg *Config, cfg *rollup.Config, l2 L2Chain, l1 L1Chain, espressoClient *espressoClient.Client, altSync AltSync, network Network, log log.Logger, snapshotLog log.Logger, metrics Metrics, sequencerStateListener SequencerStateListener, syncCfg *sync.Config) *Driver {
	...
	sequencer := NewSequencer(log, cfg, meteredEngine, l2, attrBuilder, findL1Origin, espressoClient, metrics)
